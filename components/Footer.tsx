...
import { FiMail, FiPhone, FiMapPin, FiSend, FiFacebook, FiTwitter, FiInstagram, FiArrowUp } from "react-icons/fi"
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-400">
              <div className="flex items-start">
                <FiMapPin className="h-5 w-5 text-emerald-500 mr-3 mt-0.5 flex-shrink-0" />
                <span>Abuja, Nigeria</span>
              </div>
              <div className="flex items-center">
                <FiPhone className="h-5 w-5 text-emerald-500 mr-3 flex-shrink-0" />
                <a href="tel:+2347031031944" className="hover:text-emerald-400 transition-colors">+234 703 103 1944</a>
              </div>
              <div className="flex items-center">
                <FiMail className="h-5 w-5 text-emerald-500 mr-3 flex-shrink-0" />
